                        ...
                        questions.map((question) => {
                            return (
                                ...
                                {!question.isAnswered && (
                                        ...
                                        type="button"
                                        aria-label="Marcar como Gostei"//Attr de acessibilidade
                                        onClick={() => handleLikeButton(question.id, question.likeId)}// fazemos como arrow quando nossa função tem parâmetro
                                        >
                                            ...
                                            {/*Colocamos todo o svg para podermos alterar a cor da imagem*/}
                                        </button>
                                )}
                                </Question>
